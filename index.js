...
const redirectUri = 'http://localhost:8000/callback'; // Ensure this matches the redirect URI in your Spotify app settings
...
app.get('/callback', async (req, res) => {
    ...
    try {
        ...
        res.redirect(`http://localhost:8000?access_token=${accessToken}`);
    } catch (error) {
